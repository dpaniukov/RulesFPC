...
#This file rearranges behavioral files to openfmri standard for level 1 analysis

set project_dir = "/mnt/net/LaCie/Analysis/RuleSwitch/"
set model_name = 'univar1a_LearnApply_rt'
set task = "001"
set repo_dir = "/mnt/net/LaCie/Dmitrii/repos/rules/"
...
foreach subj (001 002 004 005 006 008 010 012 013 014 015 017 018 021 022 023 024 025 026 027)
	...
	cp ${repo_dir}univariate/${model_name}/behave/source_files/Subject${subj}_${model_name}_ev7_run${run}.txt ${out_dir}ev007.txt
	cp ${repo_dir}univariate/${model_name}/behave/source_files/Subject${subj}_${model_name}_ev8_run${run}.txt ${out_dir}ev008.txt
